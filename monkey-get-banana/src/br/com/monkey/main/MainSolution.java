...
public class MainSolution
{
    ...
    static int getAmountBananas(int mat[][], int m, int n)
    {
        ...
        //Varivael para contar quantas vezes o statement é percorrido
        int totalVezes = 1;
        
        //Fiz uma iteração reversa para preencher da ultima coluna para a primeira fazendo uma soma
        ...
        //Faz um print da versão final da matriz já com a somas de cada caminho
        IslandBO.showMatrix(matAux);
        
        int resposta = 0;
        //Percorre todos os valores da primeira coluna
        //Esse será o maior valor dentro do caminho permitido
    ...
    public static void main(String arg[])
    {
        ...
        System.out.print("O total maximo de bananas é de: " + getAmountBananas(mat, m, n));
    }
